...
import { Bell, Search, User, Sun, Moon, Menu, LogOut } from "lucide-react";
    ...
    <>
      <header className="h-16 shrink-0 sticky top-0 z-40 border-b border-neutral-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md flex items-center justify-between px-4 sm:px-6 transition-colors gap-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link to="/profile" className="flex items-center gap-2.5 py-1 px-1.5 rounded-md text-body-sm text-neutral-700 dark:text-zinc-300 hover:bg-neutral-50 dark:hover:bg-zinc-800/80 transition-colors">
